  ...
  return (
    <header className={styles.root}>
      ...
      <nav className={styles.navbar}>
        ...
        <NavLink className={styles.link} to='/work'><h3 className={styles.h3}>Offer</h3><h4 className={styles.h4}>See some of my work</h4><h5  className={styles.h5}>hope you enjoy it</h5></NavLink>
