  ...
  return (
    <div className={styles.parent}>
      <section className={styles.tiledGallery}>
        ...
        <div className={styles.tile}><a className={styles.a} href=''>Fiverr</a></div>
        ...
        <div className={styles.tile}><a className={styles.a} href=''>Schedule a call</a></div>
        ...
        <CopyToClipboard text={'07898397503'} onCopy={handleCopied}>
          <div className={styles.tile} onClick={handleCallMe}><span className={styles.a}>{callMe}</span></div>
        </CopyToClipboard>
        <CopyToClipboard text={'skorskaga@gmail.com'} onCopy={handleCopied}>
          <div className={styles.tile}><span className={styles.a}>Email me</span></div>
        </CopyToClipboard>
      </section>
